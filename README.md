...
http://localhost:8100/CURRENCY-CONVERSION-MICROSERVICE/currency-conversion/from/USD/to/IND/quantity/10
http://localhost:8100/CURRENCY-CONVERSION-MICROSERVICE/currency-conversion-feign/from/USD/to/IND/quantity/10
```
